...
urlpatterns = [
    ...
    path("shubhendu", views.shubhendu, name='shubhendu'),
    path("aniket", views.aniket, name='aniket'),
    path("anirudh", views.anirudh, name='anirudh'),
    path("anmol", views.anmol, name='anmol'),
    path("ankit", views.ankit, name='ankit'),
    ...
    path("ratan", views.ratan, name='ratan'),
    path("rabindra", views.rabindra, name='rabindra'),
    path("rakesh", views.rakesh, name='rakesh'),
    path("rajiv", views.rajiv, name='rajiv'),
]